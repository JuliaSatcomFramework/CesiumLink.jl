...
- [Choose what the globe is textured with](basemap.md) — the basemap set the reader picks inside, how
  to take the network out of it, and how to put satellites around the Moon.
