...
const {
  bandLayout, cameraFollowState, cameraFollowView, countdownText, stopRows, FURNITURE_DEFAULTS,
...
// --- the defaults are stated once, and three items are off ---
{
  const off = Object.keys(FURNITURE_DEFAULTS).filter((id) => !FURNITURE_DEFAULTS[id]);
  assert.deepEqual(off, ["projection", "navHelp", "inspector"], "these are not built until asked for");
