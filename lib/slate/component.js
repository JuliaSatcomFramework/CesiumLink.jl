...
// audience page stutters. That window thus gets a note, and no viewer.
const PRESENTER = new URLSearchParams(location.search).get("present") === "1";

export default ({ params }) => PRESENTER
  ? html`<div style="padding:8px;font-style:italic">CesiumLink scene: shown in the audience window.</div>`
  : html`
  <div
