...
async function redraw(index) {
  ...
  shown = want.map(({ spec, grid }, i) => {
    ...
    layer.magnificationFilter = nearest ? Cesium.TextureMagnificationFilter.NEAREST : Cesium.TextureMagnificationFilter.LINEAR;
    layer.minificationFilter = nearest ? Cesium.TextureMinificationFilter.NEAREST : Cesium.TextureMinificationFilter.LINEAR;
